...
def main():
    ...
    # parser.add_argument("-filename","-commands.gcode", help="gcode to be sent",metavar="port name")
    # parser.add_argument("-port", "-COM14", help="serial port", metavar="port name")
    # parser.add_argument("-baudrate", "-115200", default=115200, type=int, help="baud rate, default 115200", metavar="baud rate")
    parser.add_argument("filename", help="gcode to be sent")
    parser.add_argument("-p", "--port", help="serial port", metavar="port name")
    parser.add_argument("-b", "--baudrate", default=1200, type=int, help="baud rate, default 115200", metavar="baud rate")
